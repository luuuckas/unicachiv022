...
public class ExcelExporterCate {
    ...
    public static void main(String[] args) {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM categoria"); // Consulta a la tabla "categorias"
            ...
            ExcelExporterCate exporter = new ExcelExporterCate();
            String filePath = "Categorias.xlsx"; // Nombre del archivo de Excel
    ...
    public void exportToExcel(List<String> data, String filePath) throws IOException {
        ...
        Sheet sheet = workbook.createSheet("Categorias"); // Nombre de la hoja
